...
%% Title pages
\input{misc/titleLIPN}
%\input{misc/titleUQAM}

%\addcontentsline{toc}{chapter}{Thanks}
%\input{misc/remerciements}
...
\chapter{Related Work}\label{chap2:related_work}
\chaptermark{Related Work}
\input{chapters/2-related_work}

% \chapter{Differentiable MRF Inference for Training CO Solution Predictors}\label{chap3:differentiable_mrf}
% \chaptermark{Differentiable MRF Inference}
% \input{chapters/3-nair_mrf}

\chapter{Denoising and MRF inference}\label{chap4:denoising}
\chaptermark{Denoising and MRF inference}
\input{chapters/4-denoising}
...
% \input{chapters/5-feature-to-factor_mappings}
