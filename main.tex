...
\newif\ifprintversion
% \printversiontrue   % uncomment for print version
\printversionfalse    % PDF/screen version

\ifprintversion
  \newcommand{\thesisclearpage}{\cleardoublepage}
\else
