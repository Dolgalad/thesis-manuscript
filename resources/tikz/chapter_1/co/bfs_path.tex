\begin{figure}[H]
    ...
    \begin{subfigure}{0.32\textwidth}
        ...
        \end{tikzpicture}
        \caption{Depth-First Search (DFS) with backtracking}
        \label{fig:dfs_path}
    \end{subfigure}
    \hfill
    %--------------------- BFS ---------------------%
    \begin{subfigure}{0.32\textwidth}
        ...
        \end{tikzpicture}
        \caption{Breadth-First Search (BFS) visiting nodes by level}
        \label{fig:bfs_path}
    \end{subfigure}

    \caption{Traversal paths of Diving (blue), DFS (red), and BFS (green) on the same search tree. Faint gray edges show the full tree; colored bent arrows illustrate the actual search path including backtracking.}
