...
\node[vvec] (hi) at (0,1.8) {$\EMB_i$};
\node[vvec] (hj) at (0,0.6) {$\EMB_j$};
\node[cvec] (hc1) at (0,-0.8) {$\EMB_{c_1}$};
\node[cvec] (hc2) at (0,-2.0) {$\EMB_{c_2}$};
...
% labels inside slice
\node[tiny] at (1.05,1.08) {$\EMB_i\in\mathbb{R}^d$};
\node[tiny] at (1.05,0.22) {$\EMB_j\in\mathbb{R}^d$};
\node[tiny] at (1.05,-0.63) {$\EMB_{c_1}\in\mathbb{R}^d$};
\node[tiny] at (1.05,-1.48) {$\EMB_{c_2}\in\mathbb{R}^d$};
...
% labels inside slice
\node[tiny] at (1.15,1.08) {$\tilde \EMB_i \in \mathbb{R}^d$};
\node[tiny] at (1.15,0.22) {$\tilde \EMB_j \in \mathbb{R}^d$};
\node[tiny] at (1.15,-0.63) {$\tilde \EMB_{c_1} \in \mathbb{R}^d$};
\node[tiny] at (1.15,-1.48) {$\tilde \EMB_{c_2} \in \mathbb{R}^d$};
...
\node[ovec] (hout) at (1,-0) {$\EMB_{\alpha}$};
