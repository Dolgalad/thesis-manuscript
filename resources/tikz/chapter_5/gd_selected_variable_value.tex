...
table[
    col sep=comma,
    x=iter,
    y expr=\thisrow{gnn__value__mean}+\thisrow{gnn__value__std}
...
table[col sep=comma, x=iter, y=gnn__value__mean]
{resources/data/chapter_5/scp_n50_m50_k5_egg_selected_variable_diagnostics.csv};
...
table[
    col sep=comma,
    x=iter,
    y expr=\thisrow{gnn_lbp_full__value__mean}+\thisrow{gnn_lbp_full__value__std}
]{resources/data/chapter_5/scp_n50_m50_k5_egg_selected_variable_diagnostics.csv};
\addplot[name path=full_lo_egg_1, draw=none]
table[
    col sep=comma,
...
table[col sep=comma, x=iter, y=gnn_lbp_full__value__mean]
{resources/data/chapter_5/scp_n50_m50_k5_egg_selected_variable_diagnostics.csv};
...
table[
    col sep=comma,
    x=iter,
    y expr=\thisrow{gnn_lbp_pair__value__mean}+\thisrow{gnn_lbp_pair__value__std}
]{resources/data/chapter_5/scp_n50_m50_k5_egg_selected_variable_diagnostics.csv};
...
table[col sep=comma, x=iter, y=gnn_lbp_pair__value__mean]
{resources/data/chapter_5/scp_n50_m50_k5_egg_selected_variable_diagnostics.csv};
...
table[
    col sep=comma,
    x=iter,
    y expr=\thisrow{gnn_lbp_tree__value__mean}+\thisrow{gnn_lbp_tree__value__std}
]{resources/data/chapter_5/scp_n50_m50_k5_egg_selected_variable_diagnostics.csv};
...
table[col sep=comma, x=iter, y=gnn_lbp_tree__value__mean]
{resources/data/chapter_5/scp_n50_m50_k5_egg_selected_variable_diagnostics.csv};
...
\caption{Evolution of the mean value of $x_{i}^{(t)}$ of the variable selected at decoding step $t$, highlighting the tendency of the policy to fix variables to $0$ or $1$ over time. Columns correspond to the three SCP test distributions. Solid lines denote the mean over instances and seeds, and shaded bands represent one standard deviation.}
\label{fig:chapter_5_decoding_average_value}
\end{figure}