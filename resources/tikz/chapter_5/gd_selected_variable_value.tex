...
\caption{Evolution of the mean value of $x_{i}^{(t)}$ of the variable selected at decoding step $t$, highlighting the tendency of the policy to fix variables to $0$ or $1$ over time. Columns correspond to the three SC test distributions. Solid lines denote the mean over instances and seeds, and shaded bands represent one standard deviation.}
